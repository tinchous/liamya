        ...
        <main className="pt-80 pb-32">
          <div className="max-w-6xl mx-auto px-8">
            ...
            <div className="grid md:grid-cols-2 gap-12">
              {/* Formulario */}
              <div className="bg-black/60 border-8 border-orange-500 rounded-3xl p-12 shadow-2xl">
              ...
              <div className="bg-black/60 border-8 border-red-600 rounded-3xl p-12 shadow-2xl">
