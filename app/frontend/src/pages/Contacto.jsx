    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex flex-col items-center justify-center text-white p-6">
      <div className="max-w-4xl w-full">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          {/* Formulario */}
          <div className="bg-black/60 border-2 border-neonOrange rounded-2xl shadow-[0_0_25px_#ff8c00] p-8">
          ...
          <div className="flex flex-col justify-center bg-black/60 border-2 border-neonRed rounded-2xl shadow-[0_0_25px_#ff2d2d] p-8">
