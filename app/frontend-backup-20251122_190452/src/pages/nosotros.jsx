        ...
        <main className="pt-80 pb-32">
          <div className="max-w-6xl mx-auto px-8">
            ...
            <div className="space-y-12">
              <section className="bg-black/85 border-8 border-orange-500 rounded-3xl p-12 shadow-2xl">
              ...
              <section className="bg-black/85 border-8 border-red-600 rounded-3xl p-12 shadow-2xl">
