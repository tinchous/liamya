    ...
    <>
      <div className="relative min-h-screen">
        <video autoPlay muted loop playsInline className="fixed top-0 left-0 w-full h-full object-cover -z-10">
          <source src="/videos/bolsainicio.mp4" type="video/mp4" />
        </video>
        ...
        <main className="pt-80 pb-32">
          <div className="max-w-7xl mx-auto px-8 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-12 mt-20">
              <Link to="/productos?categoria=ROTISERIA&destacados=MILANESA%20DE%20CARNE,MILANESA%20DE%20POLLO" className="group">
