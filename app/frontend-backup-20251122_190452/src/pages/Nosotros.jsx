  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto p-8 text-center">
        ...
        <section className="mb-10 bg-black/75 border-2 border-neonOrange rounded-2xl shadow-[0_0_25px_#ff8c00] p-6 text-left">
        ...
        <section className="mb-10 bg-black/75 border-2 border-neonRed rounded-2xl shadow-[0_0_25px_#ff2d2d] p-6 text-left">
        ...
        <section className="bg-black/75 border-2 border-neonOrange rounded-2xl shadow-[0_0_25px_#ff8c00] p-6 text-left">
          <h2 className="text-3xl font-display text-neonOrange mb-4 drop-shadow-[0_0_10px_#ff8c00]">
            Nuestra Visión
          </h2>
          <p className="text-gray-300 leading-relaxed">
